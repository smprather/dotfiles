...
keymap("n", "v", "V", opts_noremap_silent)
keymap("n", "V", "v", opts_noremap_silent)
...
keymap("v", "<", "<gv", opts_noremap_silent)
keymap("v", ">", ">gv", opts_noremap_silent)

-- Navigate buffers
keymap("n", "<c-j>", ":bnext<cr>", opts_noremap_silent)
keymap("n", "<c-k>", ":bprevious<cr>", opts_noremap_silent)
...
-- splits
keymap("n", "<leader>v", ":vsplit<cr>:bn<cr>", opts_noremap_silent)
keymap("n", "<leader>h", ":split<cr>:bn<cr>", opts_noremap_silent)
...
keymap("n", "Q", "@q", opts_noremap_silent)

-- Myles keymaps to change to lua later
-- Toggle syntax highlighting when more performance is needed (replaced with <leader>eh and <leader>dh above)
-- vim.cmd(
