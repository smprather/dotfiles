...
; Keep plugin include list in sync with plugins/*.ahk and reload if changed.
...
; Auto-generated include file with one #Include per plugins/*.ahk file.
#Include *i %A_ScriptDir%\plugins\_autoload_plugins.generated.ahk

RefreshPluginIncludes()
{
    plugins_dir := A_ScriptDir . "\\plugins"
    generated := plugins_dir . "\\_autoload_plugins.generated.ahk"

    if !DirExist(plugins_dir)
        DirCreate(plugins_dir)

    plugin_files := []
    Loop Files, plugins_dir . "\\*.ahk", "F"
    {
    ...
    for plugin_path in plugin_files
        content .= "#Include *i \"" . plugin_path . "\"`n"
